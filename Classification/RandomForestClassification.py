"""
Random Forest classification model to determine if someone will buy a new
...
# Only using 10 trees as dataset is very simple, can use more, default is 100.
# Too many trees results in overfitting.
